...
export const validateMyRestaurantRequest = [
    ...
    body("estimatedDeliveryTime").isInt({ min: 0 }).withMessage("Estimated delivery time must be a positive interger"),
    body("cuisines").isArray().withMessage("Cuisined must be an array").not().isEmpty().withMessage("Cuisines array cannot be empty"),
